...
public class TelaGenio extends javax.swing.JFrame {
    ...
    public TelaGenio() { //Construtor
        initComponents();
        lblFrase.setText("<html>Vou pesnar em um valor entre<br/> <strong>1 e 5</strong>. Tente adivinhar</html> ");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 70, 200, 80));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Balão.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 28, 293, 190));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 270, 40, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 310, -1, -1));
